...
namespace SocketServerAcceptMultipleClient
{
    public class SocketServer
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("4G接收服务器");
            Console.WriteLine("开启4G终端监听......");
                ...
                try
                {
                   ...
                   /* if (strSRecMsg.Contains("connect"))
                    ...
                    else*/
                    {
                        ...
                        if (strMsg.Length != 8)
                        {
                            Console.WriteLine("数据不全，数据长度不对！");
                        }
                        else
                        {
                            //插入数据库
                            data.insertData(strMsg);

                            //将发送的字符串信息附加到文本框txtMsg上
                            Console.WriteLine("客户端:" + socketServer.RemoteEndPoint + ",time:" + GetCurrentTime() + "\r\n" + strMsg[0] + "," + strMsg[1] + "," + strMsg[2] + "," + strMsg[3] + "," + strMsg[4] + "," + strMsg[5] + "," + strMsg[6] + "," + strMsg[7] + "\r\n\n");
                            //服务器想客户端推送消息 测试用例
                            //socketServer.Send(Encoding.UTF8.GetBytes("connect"));
                        }  
                    }
